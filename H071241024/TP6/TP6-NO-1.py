...
def tambah_barang():
    ...
    for nama_barang in inventory.values():
        if nama_barang['nama'].lower() == nama.lower():
...
def update_barang():
    ...
    if kode in inventory:
        nama_lama = inventory[kode]['nama']
        nama_baru = input("Masukkan nama baru: ")

        if nama_baru.lower() == nama_lama.lower():
            print("Nama baru tidak boleh sama dengan nama lama")
            return

        for barang_kode, barang in inventory.items():
            if barang['nama'].lower() == nama_baru.lower() and barang_kode != kode:
                print("Nama sudah digunakan oleh barang lain.")
                return
