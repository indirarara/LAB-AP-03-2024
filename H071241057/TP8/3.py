...
def is_valid_username(username):
    pattern = r"^([A-Za-z0-9]{5,10}$)" # TODO: Tambahkan pola untuk memvalidasi panjang karakter minimal 5 dan maksimal 20.
...
if is_valid_username(username):
    ...
    if is_valid_email(email):
        ...
        if is_valid_password(password):
            print(f"\nRegistrasi berhasil! \nHalo {username}") # TODO: Tambahkan sapaan "Halo  (username)" 
        else:
